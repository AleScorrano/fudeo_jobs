...
class SeniorityDropDown extends StatefulWidget {
  ...
  @override
  State<SeniorityDropDown> createState() => _SeniorityDropDownState();
}

class _SeniorityDropDownState extends State<SeniorityDropDown> {
