...
class NdaDropDown extends StatefulWidget {
  final String hintText = 'NDA';
  final List<String> items = ['Si', 'No'];
  NdaDropDown({
    super.key,
  });

  @override
  State<NdaDropDown> createState() => _SeniorityDropDownState();
}

class _SeniorityDropDownState extends State<NdaDropDown> {
  ...
  void addFilter(String item) {
    final NDA type = FreeLancePosition.mapNdaEnum(item);
